defmodule Giteax.Helper do
  ...
  @spec validate_params(Keyword.t(), list(atom())) :: {:ok, Keyword.t()} | {:error, %{field: atom(), errors: list(String.t())}}
  ...
  @spec validate_fetched_params(list(atom()), Keyword.t()) :: {:ok, Keyword.t()} | {:error, %{field: atom(), errors: list(String.t())}}
